...
![Форма добавления доступного инвентаря](Images/screen4.png)

![Список пунктов проката](Images/screen2.png)

![Форма добавления пункта проката](Images/screen5.png)

![Список типов инвентаря](Images/screen3.png)

![Форма добавления типа инвентаря](Images/screen6.png)
