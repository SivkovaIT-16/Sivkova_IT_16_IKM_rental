...
## Задание
Необходимо разработать Spring Web MVC или REST+JS проект с использованием базы данных, разработанной по дисциплине Базы данных и СУБД. Программа должна иметь интуитивно-понятный дружественный интерфейс и проверку вводимых значений. В программе должны присутствовать классы. Необходимо реализовать функции: • просмотр данных из базы; • редактирование данных в базе; • удаление данных из базы; • добавление данных в базу. Функции должны быть доступны для каждой таблицы. База данных должна содержать минимум 3 связные таблицы.
